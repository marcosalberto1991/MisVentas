    ...
    @foreach($listmysql as $lists)
          ...
          <form method="POST" action="subir" accept-charset="UTF-8" enctype="multipart/form-data">            
            ...
            <div class="form-group">
              <label class="col-md-4 control-label">Cambiar la foto de perfil</label>
              <div class="col-md-6">
          ...
          <form class="form-horizontal" id="formmass" role="form" accept-charset="UTF-8" enctype="multipart/form-data" >
           {{ csrf_field() }}
             <div class='form-group' id='nombre' >
              ...
              <div class='col-sm-10'>
                <input type='password' class='form-control' id='password_actual_mass' maxlength='60'   required='required' autofocus/>
            ...
            <div class='form-group' id='nombre' >
              ...
              <div class='col-sm-10'>
                <input type='password' class='form-control' id='password_mass' maxlength='60'   required='required' autofocus/>
                <p class='errorcontrasena text-center alert alert-danger hidden'></p>
              </div>
            </div>
             <div class='form-group' id='nombre' >
              ...
              <div class='col-sm-10'>
                <input type='password' class='form-control' id='password_confinma_mass' maxlength='60'   required='required' autofocus/>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="form-horizontal" id="formmass" role="form" accept-charset="UTF-8" enctype="multipart/form-data" >
           ...
           {{ csrf_field() }}
            ...
            <div class='form-group' id='telefono_1' >
              <label class='control-label col-sm-2' for='descripcion'>Teléfono 1:</label>
              <div class='col-sm-10'>
                <input type='text' class='form-control input-number' id='telefono_1_mass' maxlength='15'   required='required' autofocus>
                <p class='errortelefono_1 text-center alert alert-danger hidden'></p>
              </div>
            </div>
            
            <div class='form-group' id='telefono_2' >
              <label class='control-label col-sm-2' for='descripcion'>Teléfono 2:</label>
              <div class='col-sm-10'>
                <input type='text' class='form-control input-number' id='telefono_2_mass' maxlength='15'   required='required' autofocus>
            ...
            <div class='form-group' id='cedula' >
              <label class='control-label col-sm-2' for='descripcion'>Cédula:</label>
              <div class='col-sm-10'>
                <input type='text' class='form-control input-number' id='cedula_mass' maxlength='20'   required='required' autofocus>
          ...
          <div class="modal-footer">
            ...
            <button type="button" id="acciones" class="btn btn-primary mass edit" data-dismiss="modal">
...
<script type='text/javascript'>
  ...
  <script type='text/javascript'>
    //resetear un password
    $(document).on('click', '.edit-modal-resert', function() {
     
      

     // id = $('#id_mass').val();
      $('#acciones').attr('class', 'btn btn-warning edit-password');
      $('#acciones').text('Editar');
      $('.modal-descripcion').text('Editar la contraseña');
