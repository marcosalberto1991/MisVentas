...
class NewController_3 extends Command
{
	/**
	...
	*/
	...
	protected $signature = 'Marcos_3:new ';
	...
	* @var string
	*/
	protected $description = 'Crear un CRUD V 3.0 - 2019';
				...
				<div class="panel-heading">
					<ul>
						...
						@can('.$p.$nombrecoNtrol.' Add'.$p.')
							<a href="#" id="massadd-modal" class="massmodal massadd"><li>Añadir un '.$nombrecoNtrol.'</li></a>
						@endcan
					</ul>
				</div>
