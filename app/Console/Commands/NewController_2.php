...
class NewController_2 extends Command
{
	/**
	...
	*/
	...
	protected $signature = 'NewContro_2:new ';
...
echo "<br><br>";
	...
	file_put_contents(base_path().'/resources/views/'.$nombrecoNtrol.'/index.blade.php', $viewmarcos.$form.$enve.$enw.$envt.$envyq.$envy.$envd);
