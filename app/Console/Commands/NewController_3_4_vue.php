...
class NewController_3_4_vue extends Command
{
	/**
	...
	*/
	...
	protected $signature = 'crud_vue_3_4:new ';
	...
	* @var string
	*/
	protected $description = 'Crear un CRUD V 3.4  Bootstrap 4.1 - Vue - 2019-11';
    ...
    <div v-if="formulario_'.$nombrecoNtrol.'" class="col-lg-12 ">
        <div class="main-card mb-3 card formulario">
            <div class="card-body"><h1 class="card-title"></h1>
                  <h2>Formulario de Trasnporte</h2>
