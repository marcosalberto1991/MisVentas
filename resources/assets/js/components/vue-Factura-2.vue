        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <small id="emailHelp" class="form-text text-muted">Informacion de los datos</small>
              <div
                v-if="errors && errors.numero_factura"
                class="text-danger"
              >{{ errors.numero_factura[0] }}</div>
            </div>
