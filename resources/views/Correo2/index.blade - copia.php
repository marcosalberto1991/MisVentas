          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="form-group">
                <input class="form-control" name="remitente" id="remitente" placeholder="To:">
              </div>
              <div class="form-group">
                <input class="form-control" name="destinatario" id="destinatario" placeholder="Subject:">
              </div>
              <div class="form-group">
                 {{ csrf_field() }} 
          ...
          var destinatario = $("#destinatario").val();
            ...
            $.ajax({
              ...
              error: function (data) {
                ...
                $("#mas_tex2").addClass('borderClass').delay(4000).queue(function () {
