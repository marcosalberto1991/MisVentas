...
<section class="col-lg-11 connectedSortable">
      <div >
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                 {{ csrf_field() }} 
                    <textarea id="mensaje" name="mensaje"  class="form-control"  style="height: 300px">
 ...
 id="btn-primary"><i class="fa fa-envelope-o"></i> Send</button>
              ...
              <button type="reset" class="btn btn-default"><i class="fa fa-times"></i> Descarta archivo</button>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /. box -->
    ...
    //alert("Activaste la funcion miFuncion()");
          ...
          var file = $("#file").val();
            ...
            $.ajax({
              method: 'POST',
              url: url,
              data: {_token: token, mensaje: mensaje, remitente: remitente, destinatario: destinatario, file: file},
