...
<section class="col-lg-12 connectedSortable">
	<div class="box box-warning">
		<div class="box-header with-border">
			<h3 class="box-descripcion">Lista de Proveedor</h3>
		</div>          
		<div class="box-body">
	   		<div class="">
			<div class="panel panel-default">
				<div class="panel-heading">
					<ul>
						...
						@can('Proveedor Add')
							<button href="#" id="massadd-modal" class="btn btn-success  massmodal massadd">Añadir un Proveedor</button>
						@endcan
					</ul>
				</div>
				...
				<form class="form-horizontal" id="formmass" role="form">
					...
					<div class='form-group' id='descricion' >
						<label class='control-label' for='descripcion'>descricion:</label>
							<input type='text' name='descricion' class='form-control' id='descricion_mass' maxlength='45'   required='required' autofocus>
		...
		success: function(data) {
			if(data.errors){
				...
				//$('#massModal').modal('show');
               	...
               	toastr.success('Modificación Exitosa Proveedor!', 'Datos Modificados', {timeOut: 5000});
