...
<section class="col-lg-12 connectedSortable">
	 <div class="box box-warning">
			<div class="box-header with-border">
			  <h3 class="box-descripcion">Lista de Categoria_Proceso</h3>
			</div>          
			<!-- /.box-header -->
	  <div class="box-body">
	   <div class="">
		<div class="panel panel-default">
			<div class="panel-heading">
				<ul>
					...
					@can('Categoria_Proceso Add')
					<a href="#" id="massadd-modal" class="massmodal"><li>Añadir un Categoria_Proceso</li></a>
		...
		data-descripcion="{{ $lists->descripcion}}"
										...
										@endcan
										@can('Categoria_Proceso Eliminar') 
...
;
		...
		$('.modal-footer').on('click', '.add', function() {
			$.ajax({
				type: 'POST',
				url: 'Categoria_Proceso',
				data: {

				'id': $('#id_mass').val(),'descripcion': $('#descripcion_mass').val(),
					'_token': $('input[name=_token]').val(),
				},
				...
				success: function(data) { 
					$('.errorid').addClass('hidden');$('.errordescripcion').addClass('hidden');;
					if ((data.errors)) {
						setTimeout(function () {
							$('#massModal').modal('show');
				...
				}if(data.errors.descripcion){$('.errordescripcion').removeClass('hidden');$('.errordescripcion').text(data.errors.descripcion);
				};
					} else {
		...
		$(document).on('click', '.edit-modal', function() {
			...
			if ((data.errors)) {
				...
				if (data.errors.descripcion) {
                	...
                	toastr.success('Successfully updated Categoria_Proceso!', 'Success Alert', {timeOut: 5000});
                //update
