    ...
    @foreach($listmysql as $lists)
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              @else
                <img class="center-block profile-user-img img-responsive img-circle" src='{{ asset("perfil_usuario/$lists->foto")}}'   alt="User profile picture">   
              @endif
            ...
            {{ csrf_field() }}
             <button id="boton_todo" class="btn btn-info edit-modal " 
                    data-id="{{ $lists->id}}"
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" id="formmass_" role="form" accept-charset="UTF-8" enctype="multipart/form-data" >
           {{ csrf_field() }}
