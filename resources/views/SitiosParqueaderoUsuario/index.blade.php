...
<section class="col-lg-12 connectedSortable">
	<div class="box box-warning">
		<div class="box-header with-border">
			<h3 class="box-descripcion">Lista de SitiosParqueaderoUsuario</h3>
		</div>          
		<div class="box-body">
	   		<div class="">
			<div class="panel panel-default">
				<div class="panel-heading">
					<ul>
						...
						@can('SitiosParqueaderoUsuario Add')
							<a href="#" id="massadd-modal" class="massmodal"><li>Añadir un SitiosParqueaderoUsuario</li></a>
						@endcan
					</ul>
				</div>
				...
				<div class="panel-body" style="overflow-x:auto;">
					...
					<tr id="item_{{$lists->id}}"" class="item{{$lists->id}} @if($lists->is_published) warning @endif">
						...
						<td>
						@can('SitiosParqueaderoUsuario Show')
						...
						@endcan		
						@can('SitiosParqueaderoUsuario Editar')
						...
						@endcan
						@can('SitiosParqueaderoUsuario Eliminar') 
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" id="formmass" role="form">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="descripcion">sitios_parqueadero_id:</label>
							<div class="col-sm-10">
...
<script type='text/javascript'>
	...
	<script type='text/javascript'>
		...
		$('.modal-footer').on('click', '.delete', function() {
			$.ajax({
				type: 'DELETE',
				url: 'SitiosParqueaderoUsuario/'+id,
				data: {
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(data.errors){
                	...
                	toastr.success('Modificación Exitosa SitiosParqueaderoUsuario!', 'Datos Modificados', {timeOut: 5000});
