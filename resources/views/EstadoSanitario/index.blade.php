                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <ul>
                            ...
                            @can('EstadoSanitario Add')
                            <a class="massmodal" href="#" id="massadd-modal">
                                <li>
                                    Añadir un Estado Sanitario
                                </li>
                            </a>
                            @endcan
                        </ul>
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(data.errors){
                	...
                	toastr.success('Modificación Exitosa EstadoSanitario!', 'Datos Modificados', {timeOut: 5000});
