...
<section class="col-lg-12 connectedSortable">
	<div class="box box-warning">
		<div class="box-header with-border">
			<h3 class="box-descripcion">Lista de Niveles</h3>
		</div>          
		<div class="box-body">
	   		<div class="">
			<div class="panel panel-default">
				<div class="panel-heading">
					<ul>
						...
						@can('Niveles Add')
							<a href="#" id="massadd-modal" class="massmodal"><li>Añadir un Niveles</li></a>
						@endcan
					</ul>
				</div>
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" id="formmass" role="form">
						...
						<div class='form-group' id='codigo' >
							<label class='control-label col-sm-2' for='descripcion'>Código:</label>
							<div class='col-sm-10'>
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(data.errors){
                	...
                	toastr.success('Modificación Exitosa Niveles!', 'Datos Modificados', {timeOut: 5000});
