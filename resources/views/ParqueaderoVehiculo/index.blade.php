...
<section class="col-lg-12 connectedSortable">
	<div class="box box-warning">
		<div class="box-header with-border">
			<h3 class="box-descripcion">Lista de Parqueadero de Vehiculo</h3>
		</div>          
		<div class="box-body">
	   		<div class="">
			<div class="panel panel-default">
				<div class="panel-heading">
					<ul>
						...
						@can('ParqueaderoVehiculo Add')
							<a href="#" id="massadd-modal" class="massmodal"><li>Añadir un Parqueadero de Vehiculo</li></a>
						@endcan
					</ul>
				</div>
				...
				<div class="panel-body" style="overflow-x:auto;">
					...
					<tr>
						...
						<th>Numero</th>
						<th>Codigo</th>
						<th>Categoria de parqueadero</th>
					...
					<tr id="item_{{$lists->id}}"" class="item{{$lists->id}} @if($lists->is_published) warning @endif">
						...
						<td class="col1">{{ $lists->numero }}</td>
						<td class="col1">{{ $lists->codigo }}</td>
						<td class="col1">
						<script type="text/javascript">
							resulmunicipios_id=Foracategoria_parqueadero_id.find( cas => cas.id == {{ $lists->categoria_parqueadero_id }} );
							document.write(resulmunicipios_id.nombre); 
						</script>
						</td>
							<td class="col1">
						<script type="text/javascript">
							resulmunicipios_id=Foratipo_vehiculo_id.find( cas => cas.id == {{ $lists->tipo_vehiculo_id }} );
							document.write(resulmunicipios_id.nombre); 
						</script>
						</td>
							<td class="col1">
						...
						data-id="{{ $lists->id}}"
						data-numero="{{ $lists->numero}}"
						data-codigo="{{ $lists->codigo}}"
						data-categoria_parqueadero_id="{{ $lists->categoria_parqueadero_id}}"
						data-tipo_vehiculo_id="{{ $lists->tipo_vehiculo_id}}"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" id="formmass" role="form">
						...
						-->
						<div class="form-group">
							<label class="control-label col-sm-2" for="descripcion">Categoria de parqueadero:</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="descripcion">Tipo de vehiculo:</label>
							<div class="col-sm-10">
