...
<section class="col-lg-12 connectedSortable">
	<div class="box box-warning">
			<div class="box-header with-border">
			  <h3 class="box-descripcion">Lista de Zona</h3>
			</div>          
	<div class="box-body">
		<div class="">
		...
		<div class="panel-heading">
			<ul>
				...
				@can('Zona Add')
				<a href="#" id="massadd-modal" class="massmodal"><li>Añadir un Zona</li></a>
				@endcan
			</ul>
		</div>
		...
		$(document).on('click', '.edit-modal', function() {
			...
			if ((data.errors)) {
				setTimeout(function () {
					...
					$('#massModal').modal('show');
					toastr.error('Validacion errorea!', 'Alerta de Error '+data.errors, {timeOut: 5000});
				}, 500);
			
				if (data.errors.id) {
                	$(".error.id").removeClass("hidden");
                	$(".error.id").text(data.errors.id);
                }
				...
				if (data.errors.updated_at) {
                	...
                	toastr.success('Successfully updated Zona!', 'Success Alert', {timeOut: 5000});
                //update
