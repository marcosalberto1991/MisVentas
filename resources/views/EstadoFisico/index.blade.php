...
<section class="col-lg-12 connectedSortable">
	<div class="box box-warning">
		<div class="box-header with-border">
			<h3 class="box-descripcion">Lista de EstadoFisico</h3>
		</div>          
		<div class="box-body">
	   		<div class="">
			<div class="panel panel-default">
				<div class="panel-heading">
					<ul>
						...
						@can('EstadoFisico Add')
							<a href="#" id="massadd-modal" class="massmodal"><li>Añadir un EstadoFisico</li></a>
						@endcan
					</ul>
				</div>
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(data.errors){
                	...
                	toastr.success('Modificación Exitosa EstadoFisico!', 'Datos Modificados', {timeOut: 5000});
