...
-->
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="Perfil/Usuario" class="btn btn-default btn-flat">{{ Auth::user()->name }}</a>
                </div>
...
<!--QQQQQQQQQQQQQQQQQQ-->
          ...
          <!--QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ@@@@@@@@@@@@qqqq-->
...
-->
      ...
      <ul class="sidebar-menu">
        <li class="header">MAIN NAVIGATION</li>
         ...
         <li>
          <a href="{{ action('Arboles_EspeciesController@index') }}">
         ...
         <li>
          <a href="{{ action('Estado_procesosController@index') }}">
            <i class="fa fa-certificate"></i> <span>Estado de los Procesos</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green">new</small>
            </span>
          </a>
        ...
        <li>
          <a href="{{ action('ComunasController@index') }}">
            <i class="fa fa-calculator"></i> <span>Comunas</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green">new</small>
            </span>
          </a>
        ...
        @hasrole('Super Administrado')
         <li>
          <a href="{{ action('PermissionController@index') }}">
            <i class="fa fa-calculator"></i> <span>Permisor</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        @endhasrole
         ...
         <li>
          <a href="{{ action('Arboles_EspeciesController@CKEDITOR') }}">
            <i class="fa fa-calculator"></i> <span>ck editor </span>
            <span class="pull-right-container">
            </span>
          </a>
         ...
         <li>
          <a href="{{ action('ExcelController@index') }}">
            <i class="fa fa-calculator"></i> <span>Importal</span>
            <span class="pull-right-container">
            </span>
          </a>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ action('Arboles_EspeciesController@index') }}"><i class="fa fa-circle-o text-yellow"></i> Especie de Arboles</a></li>
            <!--
            <li><a href="{{ action('Tasa_CrecimientosController@index') }}"><i class="fa fa-circle-o text-yellow"></i> Tasa de Crecimiento</a></li>
            <li><a href="{{ action('Procedimiento_arboleController@index') }}"><i class="fa fa-circle-o text-yellow"></i> Procedimiento Arbole</a></li>
          -->
        ...
        <li><a href="{{ action('DocumentacionController@index') }}"><i class="fa fa-circle-o text-red"></i> <span>Important</span></a></li>
