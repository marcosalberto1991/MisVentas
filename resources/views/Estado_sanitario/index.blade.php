                                                                        ...
                                                                        <div class="panel panel-default">
                                                                            <div class="panel-heading">
                                                                                <ul>
                                                                                    ...
                                                                                    @can('Estado_sanitario Add')
                                                                                    <a class="massmodal" href="#" id="massadd-modal">
                                                                                        <li>
                                                                                            Añadir un Estado_sanitario
                                                                                        </li>
                                                                                    </a>
                                                                                    @endcan
                ...
                <form class="form-horizontal" id="formmass" role="form">
                    ...
                    <input autofocus="" class="form-control" id="id_mass" required="required" type="hidden">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input autofocus="" class="form-control" id="nombre_mass" maxlength="20" required="required" type="text">
		...
		$(document).on('click', '.edit-modal', function() {
			...
			if ((data.errors)) {
				...
				if (data.errors.updated_at) {
                	...
                	toastr.success('Successfully updated Estado_sanitario!', 'Success Alert', {timeOut: 5000});
                //update
