...
<section class="col-lg-12 connectedSortable">
	 <div class="box box-warning">
			<div class="box-header with-border">
			  <h3 class="box-descripcion">Lista de Estado_fisico</h3>
			</div>          
			<!-- /.box-header -->
	  <div class="box-body">
	   <div class="">
		<div class="panel panel-default">
			<div class="panel-heading">
				<ul>
					...
					@can('Estado_fisico Add')
					<a href="#" id="massadd-modal" class="massmodal"><li>Añadir un Estado_fisico</li></a>
		...
		$(document).on('click', '.edit-modal', function() {
			...
			if ((data.errors)) {
				...
				if (data.errors.updated_at) {
                	...
                	toastr.success('Successfully updated Estado_fisico!', 'Success Alert', {timeOut: 5000});
                //update
