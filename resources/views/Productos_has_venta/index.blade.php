...
<section class="col-lg-12 connectedSortable">
	<div class="box box-warning">
		<div class="box-header with-border">
			<h3 class="box-descripcion">Lista de Productos_has_venta</h3>
		</div>          
		<div class="box-body">
	   		<div class="">
				...
				<div class="panel-heading">
					<ul>
						...
						@can('Productos_has_venta Add')
							<button href="#" id="massadd-modal" class="btn btn-success  massmodal massadd">Añadir un Productos_has_venta</button>
						@endcan
					</ul>
				</div>
				...
				<div class="panel-body" style="overflow-x:auto;">
					...
					<tr id="item_{{$lists->id}}" class="item{{$lists->id}} @if($lists->is_published) warning @endif">
						...
						<script type="text/javascript">
							...
							<td class="col1">
						<script type="text/javascript">
							resulmunicipios_id=Foraventa_id.find( cas => cas.id == {{ $lists->venta_id }} );
							document.write(resulmunicipios_id.nombre); 
						</script>
						</td>
							<td class="col1">{{ $lists->cantidad }}</td>
						<td class="col1">{{ $lists->precio_producto }}</td>
						<td class="col1">
						<script type="text/javascript">
				...
				<form class="form-horizontal" id="formmass" role="form">
					...
					<div class="form-group">
						<label class="control-label" for="descripcion">productos_id:</label>
							...
							<select name="productos_id"  class="form-control" id="productos_id_mass" required="required" autofocus >
									<option value=""></option>
					...
					<div class='form-group' id='cantidad' >
						<label class='control-label' for='descripcion'>cantidad:</label>
							<input type='text' name='cantidad' class='form-control' id='cantidad_mass' maxlength='11'   required='required' autofocus>
					...
					<div class='form-group' id='precio_producto' >
						<label class='control-label' for='descripcion'>precio_producto:</label>
							<input type='text' name='precio_producto' class='form-control' id='precio_producto_mass' maxlength='45'   required='required' autofocus>
					...
					<div class="form-group">
						<label class="control-label" for="descripcion">estado_venta_id:</label>
							...
							<select name="estado_venta_id"  class="form-control" id="estado_venta_id_mass" required="required" autofocus >
									<option value=""></option>
