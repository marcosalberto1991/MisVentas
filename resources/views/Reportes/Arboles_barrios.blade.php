                    ...
                    <section class="col-lg-12 connectedSortable">
                        <div class="box box-warning">
                            <div class="box-header with-border">
                                ...
                                <div class="col-md-6">
                                    <br>
                                        <form action="{{ action('ReportesController@ArbolesBarriosPdf') }}" class="form-horizontal" id="formmass" method="post" role="form">
                                            <input name="_token" type="hidden" value="<?php echo csrf_token(); ?>">
                                                <br>
                                                    <div class="form-group" id="nombre">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select class="form-control multiple-select" id="multiples" multiple="multiple" name="barrios[]">
                                                                @foreach($Barrios as $lists)
