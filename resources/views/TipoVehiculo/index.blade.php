...
<section class="col-lg-12 connectedSortable">
	<div class="box box-warning">
		<div class="box-header with-border">
			<h3 class="box-descripcion">Lista de Tipo de Vehículo</h3>
		</div>          
		<div class="box-body">
	   		<div class="">
			<div class="panel panel-default">
				<div class="panel-heading">
					<ul>
						...
						@can('TipoVehiculo Add')
							<a href="#" id="massadd-modal" class="massmodal"><li>Añadir un Tipo de Vehículo</li></a>
						@endcan
					</ul>
				</div>
				...
				<div class="panel-body" style="overflow-x:auto;">
					...
					<tr id="item_{{$lists->id}}"" class="item{{$lists->id}} @if($lists->is_published) warning @endif">
						...
						<td class="col1">{{ $lists->precio_minutos }}</td>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" id="formmass" role="form">
						...
						<div class='form-group' id='precio_minutos' >
							<label class='control-label col-sm-2' for='descripcion'>Precio por minutos:</label>
							<div class='col-sm-10'>
								<input type='text' class='form-control' id='precio_minutos_mass' maxlength='45'   required='required' autofocus>
								<p class='errorprecio_minutos text-center alert alert-danger hidden'></p>
							</div>
						</div>
...
<script type='text/javascript'>
	...
	<script type='text/javascript'>
		...
		$(document).on('click', '.massshow-modal', function() {
			...
			$('#precio_minutos_mass').val($(this).data('precio_minutos'));
		...
		$('.modal-footer').on('click', '.add', function() {
			...
			$.ajax({
				...
				'precio_minutos': $('#precio_minutos_mass').val(),
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(data.errors){
                	...
                	toastr.success('Modificación Exitosa TipoVehiculo!', 'Datos Modificados', {timeOut: 5000});
...
function verificar(data) {
    ...
    if (data.errors.precio_minutos) {
    	$(".errorprecio_minutos").removeClass("hidden");
    	$(".errorprecio_minutos").text(data.errors.precio_minutos);
    }
...
<script type='text/javascript'>
	...
	@can('TipoVehiculo Show') 
		...
		"data-precio_minutos='"+ data.precio_minutos+"'"+
