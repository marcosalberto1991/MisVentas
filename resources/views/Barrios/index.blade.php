...
<section class="col-lg-12 connectedSortable">
	 <div class="box box-warning">
			<div class="box-header with-border">
			  <h3 class="box-descripcion">Lista de Barrios</h3>
			</div>          
			<!-- /.box-header -->
	  <div class="box-body">
	   <div class="">
		<div class="panel panel-default">
			<div class="panel-heading">
				<ul>
					...
					@can('Barrios Add')
					<a href="#" id="massadd-modal" class="massmodal"><li>Añadir un Barrios</li></a>
		...
		<script type="text/javascript">
			resulmunicipios_id=Foracomuna_id.find( cas => cas.id == {{ $lists->comuna_id }} );
					...
					<form class="form-horizontal" id="formmass" role="form">
						...
						<div class='form-group' id='nombre' >
							...
							<div class='col-sm-10'>
								...
								<select  id="comuna_id_mass"  style="visibility: hidden;" >
								...
								<select  id="municipios_id_mass" style="visibility: hidden;" >
...
;
		...
		$('.modal-footer').on('click', '.add', function() {
			$.ajax({
				...
				'id': $('#id_mass').val(),'nombre': $('#nombre_mass').val(),'comuna_id': $('#comuna_id_mass').val(),'municipios_id': $('#municipios_id_mass').val(),'created_at': $('#created_at_mass').val(),'updated_at': $('#updated_at_mass').val(),
					'_token': $('input[name=_token]').val(),
				},
				...
				success: function(data) { 
					$('.errorid').addClass('hidden');$('.errornombre').addClass('hidden');$('.errorcomuna_id').addClass('hidden');$('.errormunicipios_id').addClass('hidden');$('.errorcreated_at').addClass('hidden');$('.errorupdated_at').addClass('hidden');;
					if ((data.errors)) {
						setTimeout(function () {
							$('#massModal').modal('show');
				...
				}if(data.errors.comuna_id){$('.errorcomuna_id').removeClass('hidden');$('.errorcomuna_id').text(data.errors.comuna_id);
		...
		$(document).on('click', '.edit-modal', function() {
			...
			if ((data.errors)) {
				...
				if (data.errors.updated_at) {
                	...
                	toastr.success('Successfully updated Barrios!', 'Success Alert', {timeOut: 5000});
                //update
